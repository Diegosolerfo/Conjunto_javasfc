...
CREATE TABLE USUARIO (
    ...
    -- passwords are stored as SHA-256 hex -> 64 chars
...
CREATE TABLE MOVIMIENTO (
	ID_MOVIMIENTO SMALLINT UNSIGNED PRIMARY KEY AUTO_INCREMENT, -- ya
    FECHA_MOVIMIENTO DATE NOT NULL, -- ya
    OBSERVACIONES VARCHAR(150) NULL, -- ya
    VALOR_MOVIMIENTO MEDIUMINT UNSIGNED NOT NULL, -- y
    DESCUENTO TINYINT UNSIGNED NULL, -- ya
    TIPO_MOVIMIENTO ENUM('COMPRA','VENTA','DEUDA') NOT NULL, -- ya
	ESTADO_MOVIMIENTO ENUM('REALIZADO','PENDIENTE') DEFAULT ('REALIZADO') NOT NULL, -- estado
    CLIENTE BIGINT UNSIGNED NOT NULL, -- cliente
